<template>
  <div class="flex flex-col m-5">
    <div class="flex flex-row mx-auto gap-6 items-start mt-5">
      <div class="flex flex-col flex-1">
        ...
        <p class="text-white mb-3 crimson">
          ...
          These decks featured richly illustrated cards depicting figures,
        ...
        <p class="text-white mb-3 crimson">
          ...
          philosophy, psychology, and spiritual reflection, shaped by influences
          ranging from Renaissance humanism to modern depth psychology. What had
          once been a game evolved into a visual language for exploring
          patterns, questions, and inner states.
        </p>
      </div>

      <div class="w-1/2">
        <img
          src="../../public/Images/TarotCardPile.jpg"
          alt="Tarot Cards"
    ...
    <div class="flex flex-row gap-6 items-start mt-10">
      <div class="w-1/2">
        <img
          src="../../public/Images/ReadingTarotImage.jpg"
          alt="Tarot Cards"
          class="w-full h-auto block"
        />
      </div>
      ...
      <div class="flex flex-col flex-1">
        <p class="text-white mb-3 crimson">
          ...
          loss, growth, and change. The Minor Arcana contains 56 cards divided
          into four suits, reflecting the rhythms and challenges of everyday
        ...
        <p class="text-white mb-3 crimson">
          ...
          history behind the cards. Tarot does not provide fixed answers or
